    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        //    user.setEmailVerified(true);
           ...
           if(authorizedClinetRegistrationId.equalsIgnoreCase("google"))
           {
            ...
            user.setAbout("This account in created using Google");
            ...
            // if(user2==null){    
            //     userRepo.save(user1);
            //     logger.info("google user saved "+email);
            // }
           }
           else if(authorizedClinetRegistrationId.equalsIgnoreCase("github"))
           {
                ...
                user.setPassword("dummy");
                user.setAbout("This account in created using Github");
           }
            ...
            if(user2==null){    
                userRepo.save(user);
                // logger.info("user saved in DB"+user.getEmail());
            }
